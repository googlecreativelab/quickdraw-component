define(["exports", "./dom.js", "./template.js"], function (_exports, _dom, _template) {
  ...
  /*#__PURE__*/
  function () {
    function TemplateInstance(template, processor, getTemplate) {
        ...
        var _prepareInstance = function _prepareInstance(fragment) {
          ...
          while (partIndex < parts.length && node !== null) {
            ...
            if (!(0, _template.isTemplatePartActive)(part)) {
              ...
              if (part.type === 'node') {
                var _part2 = _this.processor.handleTextExpression(_this._getTemplate);
                ...
                (_this$_parts = _this._parts).push.apply(_this$_parts, babelHelpers.toConsumableArray(_this.processor.handleAttributeExpressions(node, part.name, part.strings)));
              }
