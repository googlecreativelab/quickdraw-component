define(["exports", "./directive.js", "./dom.js", "./part.js", "./template-instance.js", "./template-result.js", "./template.js"], function (_exports, _directive, _dom, _part, _templateInstance, _templateResult, _template) {
  ...
  _exports.EventPart = _exports.PropertyPart = _exports.PropertyCommitter = _exports.BooleanAttributePart = _exports.NodePart = _exports.AttributePart = _exports.AttributeCommitter = _exports.isPrimitive = void 0;
  ...
  /*#__PURE__*/
  function () {
    function NodePart(templateFactory) {
    ...
    babelHelpers.createClass(NodePart, [{
      ...
      value: function _commitTemplateResult(value) {
        var template = this.templateFactory(value);
        ...
        if (this.value && this.value.template === template) {
          ...
          var instance = new _templateInstance.TemplateInstance(template, value.processor, this.templateFactory);
  ...
  function (_AttributeCommitter) {
    ...
    function PropertyCommitter(element, name, strings) {
      ...
      _this2 = babelHelpers.possibleConstructorReturn(this, (PropertyCommitter.__proto__ || Object.getPrototypeOf(PropertyCommitter)).call(this, element, name, strings));
    ...
    babelHelpers.createClass(PropertyCommitter, [{
      ...
      value: function _getValue() {
        ...
        return babelHelpers.get(PropertyCommitter.prototype.__proto__ || Object.getPrototypeOf(PropertyCommitter.prototype), "_getValue", this).call(this);
      }
    }, {
      key: "commit",
      value: function commit() {
  ...
  /*#__PURE__*/
  function () {
    function EventPart(element, eventName) {
