...
(function () {
  ...
  var qdEl = document.querySelector('quick-draw'); // show the current index of the drawing loaded *when* it is loaded
...
function onSelectColor(e) {
  ...
  document.getElementById('stroke-color').innerHTML = newColor === '#000' ? '' : " strokecolor=\"".concat(newColor, "\"");
  var qdEl = document.querySelector('quick-draw');
...
function onSelectCategory(e) {
  ...
  exampleValueEl.innerHTML = newCat; // qdEl.setAttribute('category', newCat);

  qdEl.category = newCat; // qdEl.setAttribute('category', newCat);
